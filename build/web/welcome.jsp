                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="full slider_cont_section">
                                                <h4>Welcome</h4>
                                                <h3><%= user.getName()%></h3>
                                                <p>You currently own </h3>
</p>
                                                <div class="button_section">
                                                    <a href="addlisting.jsp">Add a Car</a>
                                                    <a href="store.jsp">Book a Car</a>
                                                </div>                                         
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 margin_top_30">
                                <div class="full margin_top_30">
                                    ...
                                    <p class="large">Our mission has been to provide quality exotic cars with highly personalized care at a competitive price</p>
                                </div>
                                <div class="full button_section margin_top_30">
                                    <a href="about us.jsp">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 margin_top_30">
                                <div class="full margin_top_30">
                                    ...
                                    <p class="large">Check out our currently listed cars...</p>
                                </div>
                                <div class="full button_section margin_top_30">
                                    <a href="#">See More</a>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="full">
                                    <div class="choose_blog text_align_center">
                                        ...
                                        <h4>BUY BACK AGREEMENT</h4>
                                        <p>Assured buy back policy - drive any car from Avalon for a year with 25% depreciation with kms limitation on it and 75% will be refunded back to your account.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="full">
                                    <div class="choose_blog text_align_center">
                                        ...
                                        <h4>NON ACCIDENTAL CARS</h4>
                                        <p>We don't buy car's with any accidental record not even a body part been changed as per service history.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="full">
                                    <div class="choose_blog text_align_center">
                                        ...
                                        <h4>CLIENT'S CONFIDENTIALITY</h4>
